...
import { BaoCaoChiTietTaiSanService } from './bao-cao-chi-tiet-tai-san.service';
...
@Component({
  selector: 'app-bao-cao-chi-tiet-tai-san',
  templateUrl: './bao-cao-chi-tiet-tai-san.component.html',
  styleUrls: ['./bao-cao-chi-tiet-tai-san.component.css'],
})
export class BaoCaoChiTietTaiSanComponent implements OnInit {
  //#region Biến
  //  private _baocaoService = inject(BaoCaoChiTietTaiSanService);
